...
import 'package:leman_project/Views/Single_employee_view/single_employee_view.dart';
      ...
      children: <Widget>[
        spacer(
            orientation(context) == 'portrait'
                ...
                : height(context) * 0.04,
            0),
        Selector<HomeViewProvider, Tuple2<List<EmployeeEntity>, String>>(
            selector: (_, homeProvider) =>
                Tuple2(homeProvider.filteredList, homeProvider.selectedSort),
